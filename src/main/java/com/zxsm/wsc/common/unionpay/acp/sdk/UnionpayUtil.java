...
public class UnionpayUtil {
	...
	public static String unionpayRequest(String orderNo,String amt)
	{
		...
		/***商户接入参数***/
		requestData.put("merId", UnionpayBase.merId);    	          			  //商户号码，请改成自己申请的正式商户号或者open上注册得来的777测试商户号
		...
		return AcpService.createAutoFormHtml(requestFrontUrl, submitFromData,UnionpayBase.encoding);
	}
}
