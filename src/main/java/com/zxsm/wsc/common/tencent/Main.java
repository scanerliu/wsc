...
import com.zxsm.wsc.common.tencent.entity.SendRedPack;
...
public class Main {
	...
	@Autowired
	private DjUserQRcodeTools qrTools;
	
//	@Test
	public void test()
	{
//		DjUserQRcodeTools qrTools = new DjUserQRcodeTools();
		qrTools.validAccessToken();
	}
	
	public static void main(String[] args) {

		try {
			UnifiedOrderReqData data = new UnifiedOrderReqData(null, null, null, null, null, 6, null, null, null, null, null, null, null, null, null, null);
			Map<String, Object> map = data.toMap();
			
			System.out.println(StringTools.converter(map));
			
			DjUserQRcodeTools qrTools = new DjUserQRcodeTools();
			qrTools.getAccessToken();
