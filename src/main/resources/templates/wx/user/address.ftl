...
<section class="white_header">
    ...
    <a href="/wx/u/address/edit" title="新增" class="hright headright header">新增地址</a>
</section>
<!-- header end -->
...
<dl class="address_list mt20">
    <dt><span>${address.acceptName!''}</span><span>${address.telphone!''}</span></dt>
    <dd>收货地址：${address.fullAddress!''}</dd>
    <dd>
        <div style="float: left;"><i class="<#if address.isDefault?? && address.isDefault>address_choiced</#if>"></i>默认地址</div>
        <a href="/wx/u/address/edit?id=${address.id?c}" title=""><img src="/wx/images/address_edit.png"> 编辑</a>
        <a href="/wx/u/address/del?id=${address.id?c}" title=""><img src="/wx/images/address_delete.png">删除</a>
    </dd>
</dl>
</#list>
</#if>
