...
<script type="text/javascript">
    ...
    function submitForm() {
        ...
        if ($(api.data).length > 0) {
            ...
            parentObj.find("input[id='number']").val($("#txtItemZengPin_CurrentPrice").val());
        } else {
            var trHtml = '<tr class="td_c">'
            + '<td><input name="limitGoods[${total!'0'}].costPrice" type="hidden" value="${0.00!''}">'
            + '<input name="limitGoods[${total!'0'}].postFee" type="hidden" value="${0.00!''}">'
            + '<input type="text" id="id" name="limitGoods[${total!'0'}].goodsId" class="td-input" value="' + $("#txtItemZengPin_Id").val() + '" style="width:90%;" /></td>'
            + '<td><input type="text" id="title" name="limitGoods[${total!'0'}].goodsTitle" class="td-input" value="' + $("#txtItemZengPin_Title").val() + '" style="width:90%;" /></td>'
            + '<td><input type="text" id="number" name="limitGoods[${total!'0'}].quantity" class="td-input" value="' + $("#txtItemZengPin_CurrentPrice").val() + '" style="width:90%;" /></td>'
            + '<td><input type="text" id="price" name="limitGoods[${total!'0'}].salePrice" class="td-input" value="' + $("#txtItemZengPin_Price").val() + '" style="width:90%;" /></td>'
            + '<td>'
            + '<i class="icon"></i>'
...
<form name="form1" method="get" action="/management/activity/dialog/goods" id="form1">
<div>
<input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="${__EVENTTARGET!""}">
<input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="${__EVENTARGUMENT!""}">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="${__VIEWSTATE!""}">
<input type="hidden" name="statusId" value="${total!"0"}">
</div>
