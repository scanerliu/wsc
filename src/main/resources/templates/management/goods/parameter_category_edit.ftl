...
<body class="mainbody">
<form method="post" action="/management/parameter/category/save" id="form1">
<div class="aspNetHidden">
<input type="hidden" name="id" value="<#if category??>${category.id?c}</#if>">
</div>
<!--导航栏-->
<div class="location">
  <a href="/management/parameter/category/list" class="back"><i></i><span>返回列表页</span></a>
  <a href="/management/center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="/management/parameter/category/list"><span>内容类别</span></a>
  <i class="arrow"></i>
  <span>编辑分类</span>
</div>
