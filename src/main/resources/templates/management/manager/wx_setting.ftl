...
<body class="mainbody">
<form method="post" action="/management/setting/wxsetting/save" id="form1">
...
<!--导航栏-->
<div class="location">
  <a href="/management" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="/management/setting/wxsetting"><span>内容管理</span></a>
  <i class="arrow"></i>
  <span>编辑内容</span>
</div>
...
<div id="floatHead" class="content-tab-wrap" style="height: 42px;">
  <div class="content-tab">
    <div class="content-tab-ul-wrap">
      <div class="tab-title"><span>微信设置</span><i></i></div><ul>
        <li><a class="selected" href="javascript:;">微信设置</a></li>
      </ul>
    </div>
  </div>
</div>
...
<div class="tab-content" style="display: block;">
  <dl>
    <dt>自动回复内容</dt>
    <dd>
      <textarea style="margin: 0px; height: 208px; width: 501px;" name="keywords" rows="2" cols="20" class="input"><#if keywords??>${keywords!'welcome!'}</#if></textarea>
      <span class="Validform_checktip">以“,”逗号区分开，255个字符以内</span>
    </dd>
  </dl>
  <#if keyvalue?? && keyvalue?size gte 0>
  <#list keyvalue as config>
  <dl>
    <dt>点击回复</dt>
    <dd>
       key<input name="wxKey" type="text" maxlength=100 value="${config.configKey!''}" class="input normal" datatype="*2-100" sucmsg=" ">
       value<textarea name="wxValue" style="margin: 0px; height: 100px; width: 501px;" rows="2" cols="20" class="input">${config.configValue!''}</textarea>
      <span class="Validform_checktip">以“,”逗号区分开，255个字符以内</span>
    </dd>
  </dl>
  </#list>
  <dl>
    <dt>点击回复</dt>
    <dd>
       key<input name="wxKey" type="text" maxlength=100 class="input normal" datatype="*0-100" sucmsg=" ">
       value<textarea name="wxValue" style="margin: 0px; height: 100px; width: 501px;" rows="2" cols="20" class="input"></textarea>
      <span class="Validform_checktip">以“,”逗号区分开，255个字符以内</span>
    </dd>
  </dl>
  </#if>
