...
<body class="mainbody">
<form method="post" action="/management/manager/role/list" id="form1">
...
<div id="floatHead" class="toolbar-wrap" style="height: 52px;">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="/management/manager/role/edit"><i></i><span>新增</span></a></li>
...
<div class="table-container">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
    <tbody><tr class="odd_bg">
      ...
      <th align="center" width="12%">类型</th>
    ...
    <#if role_page??>
      ...
      <tr>
        ...
        <td><a href="/management/manager/role/edit?id=${item.id?c}">${item.title!''}</a></td>
        <td align="center"><#if item.categoryId??><#if item.categoryId==0>超级管理员<#elseif item.categoryId==1>管理员</#if></#if></td>
        <td><input name="sortId" type="text" value="${item.sortId!''}" class="sort" onkeydown="return checkNumber(event);"></td>
        <td align="center">
          <a href="/management/manager/role/edit?id=${item.id?c}">修改</a>
        </td>
      </tr>
      </#list>
    </#if>
