...
$(function () {
    ...
    $(".productIdRadio").click(function(){
        $.ajax({
            url : '/management/product/parameter/'+$(this).val() <#if goods??>+"?goodsId=${goods.id?c}"</#if>,
            type : 'GET',
...
<#if product_list?? && product_list?size gt 0>
  ...
  <div id="productSelectDiv">
    <#include "/management/product_param_list.ftl" >
  </div>
</#if>
                ...
                <dl>
                    ...
                    <dd>
                        <div class="rule-multi-checkbox">
                            <span>
                                <#if param.valueList??>
                                	<#if goods?? && goods.paramList?? && goods.paramList?size gt param_index><input type="hidden" name="paramList[${param_index}].id" value="${goods.paramList[param_index].id?c}" /></#if>
                ...
                <dl>
                    ...
                    <dd>
                        <div class="rule-multi-radio">
                            <span>
                                <#if param.valueList??>
                                	<input type="hidden" name="paramList[${param_index}].id" value="${goods.paramList[param_index].id?c}" />
