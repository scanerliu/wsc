...
<body class="mainbody">
<form method="post" action="/management/parameter/category/list" id="form1">
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="/management/parameter/category/edit"><i></i><span>新增</span></a></li>
      ...
      <#list category_list as item>
        <tr>
          ...
          <td>
            ...
            <a href="/management/parameter/category/edit?id=${item.id?c}">${item.title!''}</a>
          </td>
          <td><input name="sortId" type="text" value="${item.sortId!''}" class="sort" onkeydown="return checkNumber(event);"></td>
          <td align="center">
            <a href="/management/parameter/category/edit?parentId=${item.id?c}">添加子类</a>
            <a href="/management/parameter/category/edit?id=${item.id?c}">修改</a>
          </td>
        </tr>
      </#list>
    </#if>
