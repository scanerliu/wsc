...
<body class="mainbody">
<form method="post" action="/management/parameter/list" id="form1">
...
<div id="floatHead" class="toolbar-wrap" style="height: 52px;">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="/management/parameter/edit"><i></i><span>新增</span></a></li>
...
<div class="table-container">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
    ...
    <#if parameter_page??>
      <#list parameter_page.content as item>
      <tr>
        <td align="center">
        ...
        <td><a href="/management/parameter/edit?id=${item.id?c}">${item.title!''}</a></td>
        <td>${item.categoryTitle!''}</td>
        <td><input name="sortId" type="text" value="${item.sortId!''}" class="sort" onkeydown="return checkNumber(event);"></td>
        <td align="center">
          <a href="/management/parameter/edit?action=Copy&id=${item.id?c}">复制</a>
          <a href="/management/parameter/edit?id=${item.id?c}">修改</a>
        </td>
      </tr>
      </#list>
    </#if>
