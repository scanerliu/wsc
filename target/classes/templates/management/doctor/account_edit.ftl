...
<body class="mainbody">
<form method="post" action="/management/doctor/account/save" id="form1">
...
<div class="tab-content" style="display: block;">
  <dl>
    <dt>账号</dt>
    <dd>
      <input name="username" type="text" value="<#if doctor??>${doctor.username!''}</#if>" class="input normal" datatype="*2-20" sucmsg=" ">
      <span class="Validform_checktip">*必填、输入11位手机号</span>
    </dd>
  </dl>
  <dl>
    <dt>密码</dt>
    <dd>
      <input name="password" type="text" value="<#if doctor??>${doctor.password!''}</#if>" class="input normal" datatype="*6-24" sucmsg=" ">
      <span class="Validform_checktip">*必填、6~24位字符</span>
    </dd>
  </dl>
  <dl>
    <dt>当前状态</dt>
    <dd>
      <div class="rule-multi-radio">
        <span style="display: none;">
          <input type="radio" name="status" value="0" <#if !doctor?? || !doctor.status?? || doctor.status==0>checked="checked"</#if>><label>禁用</label>
          <input type="radio" name="status" value="1" <#if doctor?? && doctor.status?? && doctor.status==1>checked="checked"</#if>><label>启用</label>
        </span>
      </div>
    </dd>
  </dl>
  ...
  <dl>
    <dt>已服务人数设置</dt>
    <dd>
      <input name="servedNo" type="text" value="<#if doctor??>${doctor.servedNo!''}</#if>" class="input normal" datatype="*1-20" sucmsg=" ">
  ...
  <dl>
    <dt>当前服务人数</dt>
    <dd>
      <input name="serveNo" type="text" value="<#if doctor??>${doctor.serveNo!''}</#if>" class="input normal" datatype="*1-20" sucmsg=" ">
      <span class="Validform_checktip">最多20个字符</span>
    </dd>
  </dl>
  <dl>
  ...
  <dl>
    <dt>排序数字</dt>
    <dd>
      <input name="sortId" type="text" value="<#if doctor??>${doctor.sort!'99'}<#else>99</#if>" class="input small" datatype="n" sucmsg=" ">
