...
<body class="mainbody">
<form method="post" action="/management/ad/category/list" id="form1">
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="/management/ad/category/edit"><i></i><span>新增</span></a></li>
...
<div class="table-container">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
    ...
    <tr class="odd_bg">
      ...
      <th align="left" width="12%">宽度</th>
      <th align="left" width="12%">高度</th>
      ...
      <#list category_list as item>
        <tr>
          ...
          <td>
            ...
            <a href="/management/ad/category/edit?id=${item.id?c}">${item.title!''}</a>
          </td>
          <td>${item.width!}</td>
          <td>${item.height!}</td>
          <td><input name="sortId" type="text" value="${item.sortId!''}" class="sort" onkeydown="return checkNumber(event);"></td>
          <td align="center">
            <a href="/management/ad/category/edit?id=${item.id?c}">修改</a>
          </td>
        </tr>
      </#list>
    </#if>
