...
<body class="mainbody">
<form method="post" action="/management/express/list" id="form1">
...
<div id="floatHead" class="toolbar-wrap" style="height: 52px;">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a class="add" href="/management/express/edit"><i></i><span>新增</span></a></li>
...
<div class="table-container">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
    <tbody><tr class="odd_bg">
      ...
      <th align="left">名称</th>
      <th align="center" width="16%">编码</th>
      <th width="16%" align="center">状态</th>
      <th align="left" width="65">排序</th>
      <th width="10%">操作</th>
    </tr>
    
    <#if express_type_page??>
      <#list express_type_page.content as item>
      <tr>
        <td align="center">
        ...
        <td><a href="/management/express/edit?id=${item.id?c}">${item.title!''}</a></td>
        ...
        <td align="center">
          <a href="/management/express/edit?action=Copy&id=${item.id?c}">复制</a>
          <a href="/management/express/edit?id=${item.id?c}">修改</a>
        </td>
      </tr>
      </#list>
    </#if>
...
<!--内容底部-->
<#assign PAGE_DATA=express_type_page />
