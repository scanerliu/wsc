...
<section class="white_header">
    ...
    <div class="htitle header">血压详情</div>
	...
	<div class="swiper-wrapper">
		...
		<div class="swiper-slide">
			...
			<section class="h_l_list mt20">
				<dl>
					<dt>${health.addDate?string("yyyy-MM-dd")}</dt>
					<dd>
						<ul>
							<li><span>${health.value1!''}</span>/<span>${health.value2!''}</span>mmHg</li>
							<li><span>${health.value3!''}</span>bpm</li>
							<li><span>${health.attribute1!'无数据'}</span></li>
						</ul>
					</dd>
				</dl>
			</section>
