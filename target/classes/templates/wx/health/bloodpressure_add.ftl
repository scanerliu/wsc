...
<section class="white_header">
    ...
    <div class="htitle header">新增血压记录</div>
    <a href="#" title="" class="hright headright header">帮助</a>
</section>
<!-- header end -->

<!-- 主要参数 -->
<form action="/wx/health/add/1" onsubmit="return check();" method="POST" >
<#if huid??><input type="hidden" name="huid" value="${huid?c}" /></#if>
<section class="h_a_info mt20">
	<dl>
		<dt>舒张压(低压)</dt>
		<dd><input type="text" id="value2" name="value2" placeholder="请输入" />mmHg</dd>
	</dl>
	<dl>
		<dt>收缩压(高压)</dt>
		<dd><input type="text" id="value1" name="value1" placeholder="请输入"  />mmHg</dd>
	</dl>
	<dl>
		<dt>心率</dt>
		<dd><input type="text" id="value3" name="value3" placeholder="请输入" />bpm</dd>
	</dl>
</section>
<!-- 主要参数 end -->  
