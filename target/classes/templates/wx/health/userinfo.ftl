...
<section class="h_i_list">
	<span>血压记录</span>
	<a href="/wx/health/list/1?huid=${user.id?c}" class="look">查看></a>
...
<section class="h_i_list">
	<span>血糖记录</span>
	<a href="/wx/health/list/2?huid=${user.id?c}" class="look">查看></a>
</section>
<!-- 列表 end -->  
...
<section class="h_i_list">
	<span>体重记录</span>
	<a href="/wx/health/list/3?huid=${user.id?c}" class="look">查看></a>
</section>
<!-- 列表 end -->  
</body>
</html>
